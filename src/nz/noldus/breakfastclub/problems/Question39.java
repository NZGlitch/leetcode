...
// 1 <= target <= 500 
// 
// Related Topics Array Backtracking 👍 12821 👎 264
...
class Solution {
    ...
    public List<List<Integer>> combinationSum(int[] candidates, int target, int minIndex) {
        ...
        for (int i=minIndex; i<candidates.length; i++) {
            if (candidates[i] > target)
                ...
                // fins all the lists that get to exactly target-i, then add i to those lists
